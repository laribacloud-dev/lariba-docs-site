...
Docs 0.4 is the current public documentation release.

- Added the Developer Environment documentation section.
- Added the Developer Golden Path and local environment setup guidance.
- Added Source Creation and Sentinel workflow guides.
- Reconciled Authentication, Event Ingestion, and Delivery/Recovery workflows.
- Added npm 12 project-level Git dependency policy required by the public docs build.

## Docs 0.3 — July 2026

Docs 0.3 was the previous public documentation synchronization release.
